...
import { WhatsappAnalyticsWidget } from '@/page-layout/widgets/graph/components/WhatsappAnalyticsWidget';
import { CampaignManagerWidget } from '@/page-layout/widgets/graph/components/CampaignManagerWidget';
import { AiAssistantsList } from '@/page-layout/widgets/graph/components/AiAssistantsList';
...
export const WidgetContentRenderer = ({
  ...
  switch (widget.type) {
    ...
    case 'WHATSAPP_ANALYTICS' as any:
      return <WhatsappAnalyticsWidget widget={widget} />;

    case 'CAMPAIGN_MANAGER' as any:
      return <CampaignManagerWidget />;

    case 'AI_ASSISTANTS_LIST' as any:
      return <AiAssistantsList />;
