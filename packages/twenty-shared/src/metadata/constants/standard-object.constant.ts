...
export const STANDARD_OBJECTS = {
  ...
  aiAssistant: {
    universalIdentifier: '20202020-0001-4000-8000-000000000001',
    fields: {
      id: { universalIdentifier: '20202020-0001-4001-8001-000000000001' },
      createdAt: { universalIdentifier: '20202020-0001-4001-8001-000000000002' },
      updatedAt: { universalIdentifier: '20202020-0001-4001-8001-000000000003' },
      deletedAt: { universalIdentifier: '20202020-0001-4001-8001-000000000004' },
      name: { universalIdentifier: '20202020-0001-4001-8001-000000000005' },
      promptTemplate: { universalIdentifier: '20202020-0001-4001-8001-000000000006' },
      voiceId: { universalIdentifier: '20202020-0001-4001-8001-000000000007' },
      telephonyProvider: { universalIdentifier: '20202020-0001-4001-8001-000000000008' },
      telephonyConfig: { universalIdentifier: '20202020-0001-4001-8001-000000000009' },
      position: { universalIdentifier: '20202020-0001-4001-8001-000000000010' },
      searchVector: { universalIdentifier: '20202020-0001-4001-8001-000000000011' },
      createdBy: { universalIdentifier: '20202020-0001-4001-8001-000000000012' },
      updatedBy: { universalIdentifier: '20202020-0001-4001-8001-000000000013' },
    },
    indexes: {},
  },
  callingCampaign: {
    universalIdentifier: '20202020-0002-4000-8000-000000000002',
    fields: {
      id: { universalIdentifier: '20202020-0002-4001-8001-000000000001' },
      createdAt: { universalIdentifier: '20202020-0002-4001-8001-000000000002' },
      updatedAt: { universalIdentifier: '20202020-0002-4001-8001-000000000003' },
      deletedAt: { universalIdentifier: '20202020-0002-4001-8001-000000000004' },
      name: { universalIdentifier: '20202020-0002-4001-8001-000000000005' },
      status: { universalIdentifier: '20202020-0002-4001-8001-000000000006' },
      aiAssistantId: { universalIdentifier: '20202020-0002-4001-8001-000000000007' },
      leadSourceCsvUrl: { universalIdentifier: '20202020-0002-4001-8001-000000000008' },
      totalLeads: { universalIdentifier: '20202020-0002-4001-8001-000000000009' },
      completedCalls: { universalIdentifier: '20202020-0002-4001-8001-000000000010' },
      position: { universalIdentifier: '20202020-0002-4001-8001-000000000011' },
      searchVector: { universalIdentifier: '20202020-0002-4001-8001-000000000012' },
      createdBy: { universalIdentifier: '20202020-0002-4001-8001-000000000013' },
      updatedBy: { universalIdentifier: '20202020-0002-4001-8001-000000000014' },
    },
    indexes: {},
  },
  callLog: {
    universalIdentifier: '20202020-0003-4000-8000-000000000003',
    fields: {
      id: { universalIdentifier: '20202020-0003-4001-8001-000000000001' },
      createdAt: { universalIdentifier: '20202020-0003-4001-8001-000000000002' },
      updatedAt: { universalIdentifier: '20202020-0003-4001-8001-000000000003' },
      deletedAt: { universalIdentifier: '20202020-0003-4001-8001-000000000004' },
      campaignId: { universalIdentifier: '20202020-0003-4001-8001-000000000005' },
      contactId: { universalIdentifier: '20202020-0003-4001-8001-000000000006' },
      duration: { universalIdentifier: '20202020-0003-4001-8001-000000000007' },
      status: { universalIdentifier: '20202020-0003-4001-8001-000000000008' },
      qualificationStatus: { universalIdentifier: '20202020-0003-4001-8001-000000000009' },
      transcription: { universalIdentifier: '20202020-0003-4001-8001-000000000010' },
      audioUrl: { universalIdentifier: '20202020-0003-4001-8001-000000000011' },
      position: { universalIdentifier: '20202020-0003-4001-8001-000000000012' },
      searchVector: { universalIdentifier: '20202020-0003-4001-8001-000000000013' },
      createdBy: { universalIdentifier: '20202020-0003-4001-8001-000000000014' },
      updatedBy: { universalIdentifier: '20202020-0003-4001-8001-000000000015' },
    },
    indexes: {},
  },
