...
export const STANDARD_FLAT_OBJECT_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  aiAssistant: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'aiAssistant'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'aiAssistant',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.aiAssistant.universalIdentifier,
        nameSingular: 'aiAssistant',
        namePlural: 'aiAssistants',
        labelSingular: i18nLabel(msg`AI Assistant`),
        labelPlural: i18nLabel(msg`AI Assistants`),
        description: i18nLabel(msg`An AI voice assistant agent`),
        icon: 'IconRobot',
        isSystem: false,
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
  ...
  callingCampaign: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'callingCampaign'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'callingCampaign',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.callingCampaign.universalIdentifier,
        nameSingular: 'callingCampaign',
        namePlural: 'callingCampaigns',
        labelSingular: i18nLabel(msg`Calling Campaign`),
        labelPlural: i18nLabel(msg`Calling Campaigns`),
        description: i18nLabel(msg`A bulk calling campaign`),
        icon: 'IconPhoneCall',
        isSystem: false,
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'name',
  ...
  callLog: ({
    ...
    twentyStandardApplicationId,
    dependencyFlatEntityMaps,
  }: Omit<CreateStandardObjectArgs<'callLog'>, 'context' | 'objectName'>) =>
    createStandardObjectFlatMetadata({
      objectName: 'callLog',
      dependencyFlatEntityMaps,
      context: {
        universalIdentifier: STANDARD_OBJECTS.callLog.universalIdentifier,
        nameSingular: 'callLog',
        namePlural: 'callLogs',
        labelSingular: i18nLabel(msg`Call Log`),
        labelPlural: i18nLabel(msg`Call Logs`),
        description: i18nLabel(msg`Record of a single voice call`),
        icon: 'IconHistory',
        isSystem: false,
        isSearchable: true,
        labelIdentifierFieldMetadataName: 'id',
