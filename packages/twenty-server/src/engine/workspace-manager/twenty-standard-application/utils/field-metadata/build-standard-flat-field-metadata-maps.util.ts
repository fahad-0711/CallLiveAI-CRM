...
import { buildAiAssistantStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-ai-assistant-standard-flat-field-metadata.util';
import { buildCallingCampaignStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-calling-campaign-standard-flat-field-metadata.util';
import { buildCallLogStandardFlatFieldMetadatas } from 'src/engine/workspace-manager/twenty-standard-application/utils/field-metadata/compute-call-log-standard-flat-field-metadata.util';
...
const STANDARD_FLAT_FIELD_METADATA_BUILDERS_BY_OBJECT_NAME = {
  ...
  aiAssistant: buildAiAssistantStandardFlatFieldMetadatas,
  callingCampaign: buildCallingCampaignStandardFlatFieldMetadatas,
  callLog: buildCallLogStandardFlatFieldMetadatas,
} satisfies {
